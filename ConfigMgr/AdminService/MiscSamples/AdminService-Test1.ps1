...
$SelectedDevice = $DeviceList | Select-Object * | Out-GridView -Title "Select A Device" -OutputMode Single

If(!([string]::IsNullOrEmpty($SelectedDevice)))
{
    $SelectedDevice | Select-Object *
    #break;
}
else {
    Break;
...
$ClickResult = $WMIFunctionList | Select-Object * | Out-GridView -Title "AdminService WMI Function List" -OutputMode Single
