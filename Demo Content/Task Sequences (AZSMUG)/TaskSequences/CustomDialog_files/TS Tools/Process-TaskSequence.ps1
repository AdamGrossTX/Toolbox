    ...
    Do {
        Do {
            ...
            Else {
                ...
                If($TsEnv.Value("TS_ErrorList")){ $ErrorList += $TsEnv.Value("TS_ErrorList") }
                If($TsEnv.Value("TS_ActionList")) { $ActionList += $TsEnv.Value("TS_ActionList") }
            ...
            If(!($Diff)) { Start-Sleep -Milliseconds 300 }
        ...
        $TsEnv.Value("TS_ActionList") = $ActionList.ToString()
        $TsEnv.Value("TS_ActionList") = $ErrorList.ToString()
    }
